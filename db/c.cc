...
struct rocksdb_bigtable_compaction_options_t {
  ROCKSDB_NAMESPACE::CompactionOptionsBigtable* rep;
};

struct rocksdb_binomial_compaction_options_t {
  ROCKSDB_NAMESPACE::CompactionOptionsBinomial* rep;
};

struct rocksdb_constant_compaction_options_t {
  ROCKSDB_NAMESPACE::CompactionOptionsConstant* rep;
};

struct rocksdb_minlatency_compaction_options_t {
  ROCKSDB_NAMESPACE::CompactionOptionsMinLatency* rep;
};
...
void rocksdb_options_set_bigtable_compaction_options(
    rocksdb_options_t* opt, rocksdb_bigtable_compaction_options_t* bigtable) {
  opt->rep.compaction_options_bigtable = *(bigtable->rep);
}

void rocksdb_options_set_binomial_compaction_options(
    rocksdb_options_t* opt, rocksdb_binomial_compaction_options_t* binomial) {
  opt->rep.compaction_options_binomial = *(binomial->rep);
}

void rocksdb_options_set_constant_compaction_options(
    rocksdb_options_t* opt, rocksdb_constant_compaction_options_t* constant) {
  opt->rep.compaction_options_constant = *(constant->rep);
}

void rocksdb_options_set_minlatency_compaction_options(
    rocksdb_options_t* opt,
    rocksdb_minlatency_compaction_options_t* minlatency) {
  opt->rep.compaction_options_minlatency = *(minlatency->rep);
}
...
rocksdb_bigtable_compaction_options_t*
rocksdb_bigtable_compaction_options_create() {
  rocksdb_bigtable_compaction_options_t* result =
      new rocksdb_bigtable_compaction_options_t;
  result->rep = new ROCKSDB_NAMESPACE::CompactionOptionsBigtable;
  return result;
}

void rocksdb_bigtable_compaction_options_set_k(
    rocksdb_bigtable_compaction_options_t* bigtable, unsigned int k) {
  bigtable->rep->k = k;
}

unsigned int rocksdb_bigtable_compaction_options_get_k(
    rocksdb_bigtable_compaction_options_t* bigtable) {
  return bigtable->rep->k;
}

void rocksdb_bigtable_compaction_options_destroy(
    rocksdb_bigtable_compaction_options_t* bigtable_opts) {
  delete bigtable_opts->rep;
  delete bigtable_opts;
}

rocksdb_binomial_compaction_options_t*
rocksdb_binomial_compaction_options_create() {
  rocksdb_binomial_compaction_options_t* result =
      new rocksdb_binomial_compaction_options_t;
  result->rep = new ROCKSDB_NAMESPACE::CompactionOptionsBinomial;
  return result;
}

void rocksdb_binomial_compaction_options_set_k(
    rocksdb_binomial_compaction_options_t* binomial, unsigned int k) {
  binomial->rep->k = k;
}

unsigned int rocksdb_binomial_compaction_options_get_k(
    rocksdb_binomial_compaction_options_t* binomial) {
  return binomial->rep->k;
}

void rocksdb_binomial_compaction_options_destroy(
    rocksdb_binomial_compaction_options_t* binomial_opts) {
  delete binomial_opts->rep;
  delete binomial_opts;
}

rocksdb_constant_compaction_options_t*
rocksdb_constant_compaction_options_create() {
  rocksdb_constant_compaction_options_t* result =
      new rocksdb_constant_compaction_options_t;
  result->rep = new ROCKSDB_NAMESPACE::CompactionOptionsConstant;
  return result;
}

void rocksdb_constant_compaction_options_set_k(
    rocksdb_constant_compaction_options_t* constant, unsigned int k) {
  constant->rep->k = k;
}

unsigned int rocksdb_constant_compaction_options_get_k(
    rocksdb_constant_compaction_options_t* constant) {
  return constant->rep->k;
}

void rocksdb_constant_compaction_options_destroy(
    rocksdb_constant_compaction_options_t* constant_opts) {
  delete constant_opts->rep;
  delete constant_opts;
}

rocksdb_minlatency_compaction_options_t*
rocksdb_minlatency_compaction_options_create() {
  rocksdb_minlatency_compaction_options_t* result =
      new rocksdb_minlatency_compaction_options_t;
  result->rep = new ROCKSDB_NAMESPACE::CompactionOptionsMinLatency;
  return result;
}

void rocksdb_minlatency_compaction_options_set_k(
    rocksdb_minlatency_compaction_options_t* minlatency, unsigned int k) {
  minlatency->rep->k = k;
}

unsigned int rocksdb_minlatency_compaction_options_get_k(
    rocksdb_minlatency_compaction_options_t* minlatency) {
  return minlatency->rep->k;
}

void rocksdb_minlatency_compaction_options_destroy(
    rocksdb_minlatency_compaction_options_t* minlatency_opts) {
  delete minlatency_opts->rep;
  delete minlatency_opts;
}
