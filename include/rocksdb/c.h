...
typedef struct rocksdb_bigtable_compaction_options_t
    rocksdb_bigtable_compaction_options_t;
typedef struct rocksdb_binomial_compaction_options_t
    rocksdb_binomial_compaction_options_t;
typedef struct rocksdb_constant_compaction_options_t
    rocksdb_constant_compaction_options_t;
typedef struct rocksdb_minlatency_compaction_options_t
...
enum {
  ...
  rocksdb_bigtable_compaction = 3,
  rocksdb_binomial_compaction = 4,
  rocksdb_constant_compaction = 5,
  rocksdb_minlatency_compaction = 6
};
...
extern ROCKSDB_LIBRARY_API void rocksdb_options_set_bigtable_compaction_options(
    rocksdb_options_t* opt, rocksdb_bigtable_compaction_options_t* bigtable);
extern ROCKSDB_LIBRARY_API void rocksdb_options_set_binomial_compaction_options(
    rocksdb_options_t* opt, rocksdb_binomial_compaction_options_t* binomial);
extern ROCKSDB_LIBRARY_API void rocksdb_options_set_constant_compaction_options(
    rocksdb_options_t* opt, rocksdb_constant_compaction_options_t* constant);
extern ROCKSDB_LIBRARY_API void
rocksdb_options_set_minlatency_compaction_options(
    rocksdb_options_t* opt,
...
extern ROCKSDB_LIBRARY_API rocksdb_bigtable_compaction_options_t*
rocksdb_bigtable_compaction_options_create();
extern ROCKSDB_LIBRARY_API void rocksdb_bigtable_compaction_options_set_k(
    rocksdb_bigtable_compaction_options_t*, unsigned int);
extern ROCKSDB_LIBRARY_API unsigned int
rocksdb_bigtable_compaction_options_get_k(
    rocksdb_bigtable_compaction_options_t*);
extern ROCKSDB_LIBRARY_API void rocksdb_bigtable_compaction_options_destroy(
    rocksdb_bigtable_compaction_options_t*);

extern ROCKSDB_LIBRARY_API rocksdb_binomial_compaction_options_t*
rocksdb_binomial_compaction_options_create();
extern ROCKSDB_LIBRARY_API void rocksdb_binomial_compaction_options_set_k(
    rocksdb_binomial_compaction_options_t*, unsigned int);
extern ROCKSDB_LIBRARY_API unsigned int
rocksdb_binomial_compaction_options_get_k(
    rocksdb_binomial_compaction_options_t*);
extern ROCKSDB_LIBRARY_API void rocksdb_binomial_compaction_options_destroy(
    rocksdb_binomial_compaction_options_t*);

extern ROCKSDB_LIBRARY_API rocksdb_constant_compaction_options_t*
rocksdb_constant_compaction_options_create();
extern ROCKSDB_LIBRARY_API void rocksdb_constant_compaction_options_set_k(
    rocksdb_constant_compaction_options_t*, unsigned int);
extern ROCKSDB_LIBRARY_API unsigned int
rocksdb_constant_compaction_options_get_k(
    rocksdb_constant_compaction_options_t*);
extern ROCKSDB_LIBRARY_API void rocksdb_constant_compaction_options_destroy(
    rocksdb_constant_compaction_options_t*);

extern ROCKSDB_LIBRARY_API rocksdb_minlatency_compaction_options_t*
rocksdb_minlatency_compaction_options_create();
extern ROCKSDB_LIBRARY_API void rocksdb_minlatency_compaction_options_set_k(
    rocksdb_minlatency_compaction_options_t*, unsigned int);
extern ROCKSDB_LIBRARY_API unsigned int
rocksdb_minlatency_compaction_options_get_k(
    rocksdb_minlatency_compaction_options_t*);
extern ROCKSDB_LIBRARY_API void rocksdb_minlatency_compaction_options_destroy(
    rocksdb_minlatency_compaction_options_t*);

extern ROCKSDB_LIBRARY_API rocksdb_minlatency_compaction_options_t*
rocksdb_minlatency_compaction_options_create();
extern ROCKSDB_LIBRARY_API void rocksdb_minlatency_compaction_options_set_k(
    rocksdb_minlatency_compaction_options_t* minlatency_opts, unsigned int k);
