...
void ColumnFamilyOptions::Dump(Logger* log) const {
  ...
  ROCKS_LOG_HEADER(log, "Options.compaction_options_bigtable.k: %u",
                   compaction_options_bigtable.k);
  ROCKS_LOG_HEADER(log, "Options.compaction_options_binomial.k: %u",
                   compaction_options_binomial.k);
  ROCKS_LOG_HEADER(log, "Options.compaction_options_constant.k: %u",
                   compaction_options_constant.k);
  ROCKS_LOG_HEADER(log, "Options.compaction_options_minlatency.k: %u",
